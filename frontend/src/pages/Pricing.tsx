    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-accentSoft/20 flex flex-col justify-between font-sans text-textPrimary select-none">
      ...
      <header className="h-16 bg-surface border-b border-border flex items-center justify-between px-6 shrink-0">
        <Link to="/" className="flex items-center gap-2.5">
          <div className="size-8 rounded-lg bg-accent flex items-center justify-center font-bold text-white shadow-none">
            FS
          </div>
        ...
        <Link
          to="/"
          className="text-xs font-bold uppercase tracking-wider text-textSecondary hover:text-textPrimary flex items-center gap-1.5 transition-colors"
        >
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12 max-w-[1200px] mx-auto w-full">
        ...
        <div className="text-center max-w-lg mb-12">
          ...
          <Text variant="bodyMuted" className="mt-2 text-xs sm:text-sm text-textSecondary leading-relaxed">
            Get institutional-grade stock screening, 10-year financials, and automated price target alarms.
          </Text>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
          ...
          <Card className="border-border bg-surface shadow-[var(--shadow-sm)] flex flex-col justify-between h-[450px] rounded-2xl">
            <div className="p-6">
              ...
              <div className="mt-3 flex items-baseline gap-1">
                <Text variant="pageTitle" as="span" className="text-3xl font-extrabold font-mono tracking-tight text-textPrimary">
                  ₹0
                </Text>
                <Text variant="bodyMuted" as="span" className="text-textMuted text-xs font-semibold">/ year</Text>
              </div>
              <Text variant="bodyMuted" className="mt-2 text-[11px] text-textSecondary leading-relaxed">
            ...
            <div className="p-6 bg-surfaceMuted/50 border-t border-border shrink-0">
              <Button asChild variant="outline" className="w-full font-bold text-xs uppercase h-10 border-border text-textSecondary hover:bg-surfaceMuted">
          ...
          <Card className="border-accent/30 relative shadow-[var(--shadow-lg)] bg-surface ring-1 ring-accent/20 flex flex-col justify-between h-[450px] rounded-2xl">
            ...
            <div className="p-6">
              <Text variant="label" className="text-[10px] text-accent tracking-widest block">
                Premium Plan
              </Text>
              <div className="mt-3 flex items-baseline gap-1">
                <Text variant="pageTitle" as="span" className="text-3xl font-extrabold font-mono tracking-tight text-textPrimary">
            ...
            <div className="p-6 bg-surfaceMuted/50 border-t border-border shrink-0">
              <Button asChild className="w-full bg-accent hover:bg-accent/90 text-white font-bold text-xs uppercase h-10 shadow-none">
        ...
        {/* Trust badges */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 w-full max-w-2xl border-t border-border pt-8">
          <div className="flex items-center gap-3 justify-center">
            <ShieldCheck className="size-5 text-accent shrink-0" />
            <div className="text-left">
              <Text variant="body" className="font-bold text-textPrimary uppercase text-xs">Secure Payments</Text>
              <Text variant="caption" className="text-[10px] text-textMuted mt-0.5 font-medium leading-none">256-bit SSL encrypted</Text>
            </div>
          </div>
          <div className="flex items-center gap-3 justify-center">
            <HeartHandshake className="size-5 text-accent shrink-0" />
            <div className="text-left">
              <Text variant="body" className="font-bold text-textPrimary uppercase text-xs">Cancel Anytime</Text>
              <Text variant="caption" className="text-[10px] text-textMuted mt-0.5 font-medium leading-none">100% money back guarantee</Text>
            </div>
          </div>
          <div className="flex items-center gap-3 justify-center">
            <Headphones className="size-5 text-accent shrink-0" />
            <div className="text-left">
              <Text variant="body" className="font-bold text-textPrimary uppercase text-xs">24/7 Premium Help</Text>
              <Text variant="caption" className="text-[10px] text-textMuted mt-0.5 font-medium leading-none">Priority support queues</Text>
            </div>
          </div>
        </div>
      </main>
      ...
      {/* Footer */}
      <footer className="h-14 border-t border-border flex items-center justify-center shrink-0 bg-surface">
        <Text variant="caption" className="text-[10px] text-textMuted font-bold uppercase tracking-wider">
